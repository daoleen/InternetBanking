...
INSERT INTO payment_card(card_number, bank_id, client_id, amount, pin_code) VALUES ('0000-0000-0000-0001', 1000000, 1, '150.0', 'passssssssssssssHASHED'), ('0000-0000-0000-0002', 1000000, 2, '60.0', 'card2');
INSERT INTO payment_transaction(uuid, card_number, created_at) VALUES (RANDOM_UUID(), '0000-0000-0000-0001', CURRENT_TIMESTAMP());
INSERT INTO money_reservation(amount, status, payment_card, created_at, payment_transaction_id, version) VALUES ('10', 0, '0000-0000-0000-0001', CURRENT_TIME(),(SELECT uuid FROM payment_transaction LIMIT 1),0);