...
@NamedQueries({
        ...
        @NamedQuery(name = ClientAddress.FIND_BY_ADDRESS_CITY_NAME, query = "select a from ClientAddress a where a.city.name = :cityName and a.street = :street and a.houseNumber = :houseNumber and a.apartmentNumber = :apartmentNumber")
})
public class ClientAddress implements Identifiable<Long>, Serializable {
    ...
    public static final String FIND_BY_ADDRESS_CITY_NAME = "ClientAddress.findByAddressCityName";
